// This program converts a set of images to a lmdb by storing them as Datum proto buffers.
// Usage: convert_imageset [FLAGS] ROOTFOLDER/ LISTFILE DB_NAME
// where ROOTFOLDER is the root folder that holds all the images, and LISTFILE
// should be a list of files as well as their labels, in the format as subfolder1/file1.JPEG 7 ....
#include <algorithm>
...
DEFINE_string(backend, "lmdb", "The backend {lmdb} for storing the result");
...
int main(int argc, char** argv) {
  ...
  gflags::SetUsageMessage("Convert a set of images to the lmdb format used as input for Caffe.\n"
                          "Usage: convert_imageset [FLAGS] ROOTFOLDER/ LISTFILE DB_NAME\n"
                          "The ImageNet dataset for the training demo is at http://www.image-net.org/download-images\n");
