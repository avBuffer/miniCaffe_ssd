...
/* @brief Generate the detection evaluation based on DetectionOutputLayer and ground truth bounding box labels.
...
class DetectionEvaluateLayer : public Layer<Dtype> {
 public:
  explicit DetectionEvaluateLayer(const LayerParameter& param) : Layer<Dtype>(param) {}
 ...
 protected:
   ...
   *      N is the number of detections, and each row is: [image_id, label, confidence, true_pos, false_pos] */
