...
// Usage: ssd_detect [FLAGS] model_file weights_file list_file

// where model_file is the .prototxt file defining the network architecture,
// and weights_file is the .caffemodel file containing the network parameters, 
// and list_file contains a list of image files with the format as follows:
//    folder/img1.JPEG
//    folder/img2.JPEG
...
DEFINE_double(confidence_threshold, 0.01, "Only store detections with score higher than the threshold.");
