...
// Usage: create_label_map [FLAGS] MAPFILE OUTFILE
// where MAPFILE is a list of label names and optionally label ids and displaynames,
// and OUTFILE stores the information in LabelMap proto.
...
DEFINE_bool(include_background, false, "When this option is on, include none_of_the_above as class 0.");
DEFINE_string(delimiter, " ", "The delimiter used to separate fields in label_map_file.");
...
int main(int argc, char** argv) {
  ...
  gflags::SetUsageMessage("Read in pairs label names and optionally ids and display names and store them in LabelMap proto buffer.\n"
                          "Usage: create_label_map [FLAGS] MAPFILE OUTFILE\n");
